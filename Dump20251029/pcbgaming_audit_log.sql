...
CREATE TABLE `audit_log` (
  ...
  `profilepic_old_bytes` int(11) DEFAULT NULL,
  `profilepic_new_bytes` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_table_time` (`table_name`,`changed_at`),
  KEY `idx_table_row` (`table_name`,`row_pk`)
...
-- Dump completed on 2025-10-29 22:00:14
